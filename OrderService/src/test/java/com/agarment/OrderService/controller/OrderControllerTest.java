...
import com.agarment.OrderService.OrderServiceConfig;
...
import com.agarment.OrderService.model.PaymentMode;
...
public class OrderControllerTest {
    ...
    private void reduceQuantity() {
        ...
        wireMockServer.stubFor(put(urlMatching("/v1/product/reduceQuantity/.*"))
    ...
    private void getProductDetailsResponse() throws IOException {
        // GET /product/1
        wireMockServer.stubFor(get("/v1/product/1")
                .willReturn(aResponse()
                        .withStatus(HttpStatus.OK.value())
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
    ...
    public void test_WhenPlaceOrder_DoPayment_Success() throws Exception {
        ...
        MvcResult mvcResult
                = mockMvc.perform(MockMvcRequestBuilders.post("/v1/order/placeOrder")
        ...
        assertEquals(orderRequest.getQuanity(), o.getQuanity());
    ...
    public void testWhen_GetOrder_Order_Not_Found() throws Exception {
        MvcResult mvcResult
                = mockMvc.perform(MockMvcRequestBuilders.get("/v1/order/2")
                        .with(jwt().authorities(new SimpleGrantedAuthority("Admin")))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
